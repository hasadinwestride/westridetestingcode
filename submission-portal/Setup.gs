...
/**
 * 2) (ไม่บังคับ) เติมรหัสให้นักเรียนทุกแถวที่ยังไม่มีรหัส
 *
 * ปกติไม่ต้องรัน — หน้าส่งงานถามอีเมลที่ใช้สมัครเรียน ซึ่งนักเรียนจำได้อยู่แล้ว
 * ฟังก์ชันนี้มีไว้เผื่อกรณีที่อยากใช้รหัสแทนอีเมล เช่นนักเรียนสมัครด้วยอีเมลที่ไม่ค่อยได้ใช้
...
/**
 * 4) (ไม่บังคับ) ส่งอีเมลรหัส + ลิงก์พอร์ทัลให้นักเรียนที่ยังไม่ได้ส่ง
 *
 * ใช้คู่กับ generateMissingCodes() เฉพาะตอนที่เลือกใช้รหัสแทนอีเมล
